...
DSL_PATH = 'config_log/test_homolr_train_job_dsl.json'
SUBMIT_CONF_PATH = 'config_log/test_homolr_train_job_conf.json'

TASK = 'train'

GUEST_DATA_SET = 'homo_g_upd.csv'
HOST_DATA_SET = 'homo_h_upd.csv'
