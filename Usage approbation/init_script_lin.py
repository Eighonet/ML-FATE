...
DSL_PATH = 'config_lin/test_hetero_linr_train_job_dsl.json'
SUBMIT_CONF_PATH = 'config_lin/test_hetero_linr_train_job_conf.json'

TASK = 'train'

GUEST_DATA_SET = 'hetero_motor_a.csv'
HOST_DATA_SET = 'hetero_motor_b.csv'
